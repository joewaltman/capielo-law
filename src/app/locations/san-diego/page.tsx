...
const location = getLocationBySlug('san-diego');
            ...
            <div className="lg:col-span-2">
              <FadeInOnScroll>
                <div className="aspect-video rounded-xl overflow-hidden mb-8">
                  <img
                    src="https://images.unsplash.com/photo-1538097304804-2a1b932466a9?w=1200&q=80"
              ...
              <FadeInOnScroll delay={100}>
                ...
                <div className="prose prose-lg text-text-muted">
                  <p>
                    Our San Diego office is located in the heart of downtown,
                    providing easy access for clients throughout San Diego County.
                    From La Jolla to Chula Vista, we serve families and
                    individuals across the region.
                  </p>
                  <p>
                    San Diego&apos;s unique community includes military families,
                    retirees, business owners, and professionals with diverse
                    estate planning needs. We understand the specific
                    considerations that matter to San Diego residents, from
                    cross-border issues to military benefits planning.
                  </p>
                  <p>
                    Our office is conveniently located near the San Diego Trolley
                    and major freeways. We offer both in-person consultations at
                    our downtown office and virtual meetings for your convenience.
                  </p>
                </div>
              </FadeInOnScroll>
